...
angular
  ...
  .controller("appController", function($timeout, $scope) {
    ...
    app.NavigationLinks = {
      ...
      services: new NavigationLinkObject({ id: "services", name: "Services", position: 2, page: "pages/services.html" }),
      about: new NavigationLinkObject({ id: "about", name: "About", position: 3, page: "pages/about.html" }),
      connect: new NavigationLinkObject({ id: "connect", name: "Connect", position: 4, page: "pages/connect.html", previousIds: ["contact"] }),
      newClient: new NavigationLinkObject({ id: "newClient", name: "New clients", position: 5, page: "pages/newClient.html", previousId: ["intake"] }),
      resources: new NavigationLinkObject({ id: "resources", name: "Resources", position: 6, page: "pages/resources.html" })
    };
